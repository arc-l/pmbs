...
class SeachCollector:
    def __init__(self, cases, time_limit):
        ...
        self.base_directory = os.path.join(
            os.path.abspath("logs_mcts"), "mcts_ori-" + timestamp_value.strftime("%Y-%m-%d-%H-%M-%S") + "-" + str(time_limit) + "-" + name,
        )
...
if __name__ == "__main__":
    ...
    mcts_helper = MCTSHelper("logs_grasp/snapshot-post-020000.reinforcement.pth", "logs_grasp/grasp_model-89.pth", seed)
    ...
    for repeat_idx in range(repeat_num):
        ...
        # push_start = [
        #     [
        #         45 * PIXEL_SIZE + WORKSPACE_LIMITS[0][0],
        #         124 * PIXEL_SIZE + WORKSPACE_LIMITS[1][0],
        #         1.000000000000000021e-02,
        #     ]
        # ]
        # push_end = [
        #     [
        #         68 * PIXEL_SIZE + WORKSPACE_LIMITS[0][0],
        #         124 * PIXEL_SIZE + WORKSPACE_LIMITS[1][0],
        #         1.000000000000000021e-02,
        #     ]
        # ]
        # env.push_idx(env_ids_main, push_start, push_end)
        # push_start = [[5.100000000000000089e-01, 8.799999999999999489e-02, 1.000000000000000021e-02]]
        # push_end = [[5.100000000000000089e-01, 4.200000000000000955e-02, 1.000000000000000021e-02]]
        # env.push_idx(env_ids_main, push_start, push_end)
        # push_start = [[4.740000000000000324e-01, -5.799999999999999600e-02, 1.000000000000000021e-02]]
        # push_end = [[4.720000000000000306e-01, -8.000000000000007105e-03, 1.000000000000000021e-02]]
        # env.push_idx(env_ids_main, push_start, push_end)
        # push_start = [[5.480000000000000426e-01, -5.799999999999999600e-02, 1.000000000000000021e-02]]
        # push_end = [[5.480000000000000426e-01, -8.000000000000007105e-03, 1.000000000000000021e-02]]
        # env.push_idx(env_ids_main, push_start, push_end)
        # push_start = [[6.040000000000000924e-01, 4.000000000000000777e-02, 1.000000000000000021e-02]]
        # push_end = [[5.620000000000000551e-01, 1.400000000000001243e-02, 1.000000000000000021e-02]]
        # env.push_idx(env_ids_main, push_start, push_end)
        # push_start = [[6.120000000000000995e-01, -5.599999999999999423e-02, 1.000000000000000021e-02]]
        # push_end = [[5.660000000000000586e-01, -6.199999999999999956e-02, 1.000000000000000021e-02]]
        # env.push_idx(env_ids_main, push_start, push_end)
        # push_start = [
